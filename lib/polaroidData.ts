...
export const polaroidData: PolaroidItem[] = [
  // ============ CHILDHOOD PHOTOS (4) ============
  {
    ...
    date: "",
    compliment:
      "look at this cutie pie omg 😭 you were THAT girl even back then misudi  nothing has changed fr, you've always been this 💕",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#c9a84c",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "I don't think you realise how cute you were. scratch that — how cute you STILL are. this face hasn't changed one bit, misu 🥰",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#c9a84c",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "the same spark, the same eyes, the same energy. baby you were always going to grow up and ruin someone's life (mine) 😭❤️",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#c9a84c",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "somewhere this little girl was just vibing and had no idea what was coming. I'm so glad the universe led her to me, my love 🌸",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#c9a84c",
  ...
  // ============ TRADITIONAL (6) ============
  {
    ...
    date: "",
    compliment:
      "I am FLAT. every single time, no thoughts, just 😮‍💨 you in a saree is something else baby . I genuinely melt and I always want more. always.",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#d4788a",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "there's something about you in traditional that literally stops time for me. I forget to breathe. not even exaggerating, misu 😮‍💨",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#d4788a",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "timeless. literally timeless. you could be in any era, any decade, and you'd still make everyone turn and stare. that's just you, my love 😍",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#d4788a",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "the kurta, the haveli, the whole scene this looks like a movie poster and you're the lead. I'd watch it on repeat, baby 😭",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#d4788a",
  ...
  // ============ FORMAL (1) ============
  {
    ...
    date: "",
    compliment:
      "I am going CRAZY looking at this. WHO gave you the right?? baby you in formals is genuinely illegal. I cannot handle this. 😵 someone stop her",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#c9a84c",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "the way you move, the way you laugh in this  I could watch this on loop forever. you're chaos in the most beautiful way, dramebaaz 😭",
    isSpecial: false,
    specialType: null,
    isVideo: true,
    borderColor: "#e8e4dc",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "the fact that we exist in the same photo, in the same frame, breathing the same air , that's my whole world right there 🌍❤️",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#e8b4bc",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "every photo with you feels like proof. proof that something this good actually happened to me. I still can't believe it sometimes, misu 🫶",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#e8b4bc",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "you know what I love about this one? we look like us. just us. no pretending, no posing. just two idiots who got lucky 😭❤️",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#e8b4bc",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "look at us. just look. if someone told me a year ago this would be my life, I'd laugh. but here we are, my love. and I wouldn't trade it for anything 🫶",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#e8b4bc",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "this one hits different. late night, just us two, no one else around. you smiled and I knew this is home. you are home, baby 🥰",
    isSpecial: false,
    specialType: null,
    isVideo: false,
    borderColor: "#e8b4bc",
  ...
  },
  {
    ...
    date: "",
    compliment:
      "I saved this video because I never want to forget exactly how this moment felt. us, together, unscripted. this is everything, my love ❤️",
    isSpecial: false,
    specialType: null,
    isVideo: true,
    borderColor: "#e8b4bc",
